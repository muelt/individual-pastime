...
<main class="c_main" role="main">
		<h2 class="e_archive_title"><?php echo $cat->name ?></h2>
		<?php if (have_posts()) : ?>
		<div class="e_article_lists">
			...
			<div class="e_article_item">
				<div class="e_article_img">
					<a href="<?php the_permalink(); ?>"><img src="<?php echo get_the_post_thumbnail_url( get_the_ID(), 'full' );?>" alt="<?php echo get_the_title(); ?>"></a>
				</div>
